...
return [
     ...
     */
    'base_url'                        => 'https://api-projeto-3.herokuapp.com',
    ...
    'auth'                            => [
         ...
         */
        'extra_info'  => 'You can retrieve your token by <a href="#login">logging in</a>.',
    ],
     ...
     */
    'intro_text'                      => <<<INTRO
This is the API documentation used in the <a href="https://stocktrader-bay.vercel.app/" target="_blank">Stock Trader</a> project.
<br>
Project made by <a href="https://github.com/devRMA" target="_blank">devRMA</a>.
<br>
<aside class="notice">When a token expires, you can <a href="#refresh">refresh</a> on it, but if the token has already been blacklisted, you will need to login again.</aside>
<aside class="warning">You can only make 60 requests per minute. You can see the ratelimit in the response headers.</aside>
INTRO
    ,
    ...
    /*
     * [Advanced] Custom implementation of RouteMatcherInterface to customize how routes are matched
     *
     */
