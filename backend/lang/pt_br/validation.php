...
return [
    ...
    | Sinta-se livre para ajustar cada uma dessas mensagens aqui.
    |
     */
    ...
    | por algo mais amigável para o leitor, como "Endereço de e-mail" em vez de "email". Isso simplesmente nos ajuda
